...
func (b *BadgerCache) Set(ctx context.Context, key string, value interface{}, expiration time.Duration) error {
...
func (c *BadgerCache) Increment(ctx context.Context, key string, expiration time.Duration) (int64, error) {
