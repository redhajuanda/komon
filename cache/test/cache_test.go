...
import (
	...
	"github.com/redhajuanda/komon/cache/embed"
	_ "github.com/redhajuanda/komon/cache/embed"
	"github.com/redhajuanda/komon/cache/lru"
	_ "github.com/redhajuanda/komon/cache/lru"
	"github.com/redhajuanda/komon/cache/mem"
	_ "github.com/redhajuanda/komon/cache/mem"
	"github.com/redhajuanda/komon/cache/redis"
...
func testCache(t *testing.T, c cache.Cache, sleep sleepFunc) {
	...
	err = c.Set(ctx, "testexp", "any", 10*time.Second)
	assert.Nil(t, err)
